module plustimes-main where

import parse
open import lib
open import plustimes-types
import plustimes

module parsem = parse plustimes.gratr2-nt ptr
open parsem
open parsem.pnoderiv plustimes.rrs plustimes.plustimes-rtn
open import run ptr
